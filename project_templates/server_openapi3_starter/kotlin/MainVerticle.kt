...
class MainVerticle : AbstractVerticle() {
    ...
    override fun start() {
        OpenAPI3RouterFactory.createRouterFactoryFromURL(vertx, MainVerticle::class.java.getResource("/{{ openapispec_filename }}").toString(), { openAPI3RouterFactoryAsyncResult ->
