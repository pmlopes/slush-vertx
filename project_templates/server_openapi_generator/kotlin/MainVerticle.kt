...
class MainVerticle : AbstractVerticle() {
    ...
    override fun start(future: Future<Void>) {
        OpenAPI3RouterFactory.createRouterFactoryFromFile(vertx, MainVerticle::class.java.getResource("/{{ project_info.spec_filename }}").getFile(), { openAPI3RouterFactoryAsyncResult ->
